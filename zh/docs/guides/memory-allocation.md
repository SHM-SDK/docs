...
```{literalinclude} ../../../code-samples/tests/YCSB-C/ycsbc.cc
:language: cpp
...
```{literalinclude} ../../../code-samples/tests/YCSB-C/config.ini
:language: ini
...
```{literalinclude} ../../../code-samples/shm-lib/shm/mm.cc
:language: cpp
...
```{literalinclude} ../../../code-samples/shm-lib/include/shm/mm.h
:language: cpp
:start-after: template <typename T> class CXLAllocator
:end-before: void init_cacheable_allocator
```

```{literalinclude} ../../../code-samples/shm-lib/include/shm/cxl_type.h
:language: cpp
```
...
```{literalinclude} ../../../code-samples/shm-lib/include/utils/helper.h
:language: cpp
```
...
```{literalinclude} ../../../code-samples/ds/BwTree/src/bwtree.h
:language: cpp
