...
```{literalinclude} ../../../code-samples/shm-lib/include/msg/msg_queue.h
:language: c++
```

配套的 `MsgDispatcher`/`MsgCollector` 提供了“按消息类型分发处理”的线程模型：

```{literalinclude} ../../../code-samples/shm-lib/include/msg/msg_dispatcher.h
:language: c++
```
...
```{literalinclude} ../../../code-samples/shm-lib/include/connection/establish.h
:language: c++
...
```{literalinclude} ../../../code-samples/tests/YCSB-C/run_shm_ds.sh
:language: bash
